...
class AttractionTableViewController: UITableViewController , UISearchBarDelegate, UISearchResultsUpdating {
    ...
    func initialize() {
        ...
        searchController.searchBar.placeholder = "Search Attractions" // 미리보기 글자 변경
        searchController.obscuresBackgroundDuringPresentation = false // 검색하는 동안에 검색 결과 보기 컨트롤러가 모호해지는 것을 방지
        
        navigationItem.searchController = searchController // navigationItem에 searchController를 집어 넣어줌
